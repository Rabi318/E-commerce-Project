...
import { Avatar, AvatarGroup, Box, Button, Card, CardHeader, Chip, FormControl, Grid, InputLabel, Menu, MenuItem, Pagination, Paper, Select, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography } from "@mui/material";
...
const OrdersTable = () => {
  ...
  useEffect(() => {
    dispatch(getOrders());
  }, [adminOrder.shipped, adminOrder.canceled, adminOrder.confirmed, adminOrder.delivered, adminOrder.placed,
