      ...
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex felx-wrap space-x-5 justify-center">
        ...
        {/* rating and reviews */}
        <section>
          <h1 className="font-semibold text-lg pd-4">Recent Reviews & Rating</h1>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-60">65789 Ratings</p>
                </div>
        ...
        <section className="pt-10">
          <h1 className="px-5 text-xl font-bold">Similar Products</h1>
